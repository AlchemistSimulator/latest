...
title: addVertex
---
//[alchemist](../../../index.html)/[it.unibo.alchemist.model.implementations.geometry.euclidean2d](../index.html)/[AwtMutableConvexPolygon](index.html)/[addVertex](add-vertex.html)
...
| | |
|---|---|
| index | the index in the list of [vertices](vertices.html) where to put the new vertex |
| x | x coordinate |
| y | y coordinate |
