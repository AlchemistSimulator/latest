...
---
//[alchemist](../../../index.html)/[it.unibo.alchemist.boundary.gui.effects](../index.html)/[DrawNavigationGraph](index.html)
...
[jvm]\
open class [DrawNavigationGraph](index.html) : [DrawOnce](../-draw-once/index.html)

Draws the navigation graph of an [ImageEnvironmentWithGraph](../../it.unibo.alchemist.model.implementations.environments/-image-environment-with-graph/index.html).
