...
---
//[alchemist](../../../../index.html)/[it.unibo.alchemist.biochemistrydsl](../../index.html)/[BiochemistrydslParser](../index.html)/[CustomConditionsContext](index.html)
...
[jvm]\
open class [CustomConditionsContext](index.html) : ParserRuleContext
...
| | |
|---|---|
| [CustomConditionsContext](-custom-conditions-context.html) | [jvm]<br>open fun [CustomConditionsContext](-custom-conditions-context.html)(parent: ParserRuleContext, invokingState: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)) |
...
| [customCondition](custom-condition.html) | [jvm]<br>open fun [customCondition](custom-condition.html)(): [List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)<[BiochemistrydslParser.CustomConditionContext](../-custom-condition-context/index.html)><br>open fun [customCondition](custom-condition.html)(i: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [BiochemistrydslParser.CustomConditionContext](../-custom-condition-context/index.html) |
