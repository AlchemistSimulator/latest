...
[jvm]\
open class [GenericMoleculePresent](index.html)<[T](index.html) : [Number](https://docs.oracle.com/javase/8/docs/api/java/lang/Number.html)?> : [AbstractCondition](../-abstract-condition/index.html)<[T](../-neighborhood-present/index.html)> 
...
| [getQuantity](get-quantity.html) | [jvm]<br>open fun [getQuantity](get-quantity.html)(): [T](../-neighborhood-present/index.html)<br>Allows to access the threshold. |
