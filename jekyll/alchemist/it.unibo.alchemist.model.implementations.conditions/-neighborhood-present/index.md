...
[jvm]\
class [NeighborhoodPresent](index.html)<[T](index.html)> : [AbstractNeighborCondition](../-abstract-neighbor-condition/index.html)<[T](../../it.unibo.alchemist.model.implementations.environments/-limited-continuos2-d/index.html)> 
