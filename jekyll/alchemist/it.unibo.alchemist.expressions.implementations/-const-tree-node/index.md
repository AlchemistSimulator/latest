...
title: ConstTreeNode
---
//[alchemist](../../../index.html)/[it.unibo.alchemist.expressions.implementations](../index.html)/[ConstTreeNode](index.html)
...
[jvm]\
open class [ConstTreeNode](index.html) : [ATreeNode](../-a-tree-node/index.html)<HashString>
...
| | |
|---|---|
| [ConstTreeNode](-const-tree-node.html) | [jvm]<br>open fun [ConstTreeNode](-const-tree-node.html)(data: HashString)<br>a HashString representation of the constant |
