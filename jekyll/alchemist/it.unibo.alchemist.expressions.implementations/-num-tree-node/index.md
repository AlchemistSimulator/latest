...
title: NumTreeNode
---
//[alchemist](../../../index.html)/[it.unibo.alchemist.expressions.implementations](../index.html)/[NumTreeNode](index.html)
...
[jvm]\
class [NumTreeNode](index.html) : [ATreeNode](../-a-tree-node/index.html)<[Double](https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html)>
...
| | |
|---|---|
| [NumTreeNode](-num-tree-node.html) | [jvm]<br>open fun [NumTreeNode](-num-tree-node.html)(data: [Double](https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html))<br>the number to embed |
| [NumTreeNode](-num-tree-node.html) | [jvm]<br>open fun [NumTreeNode](-num-tree-node.html)(data: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))<br>This constructor is provided for better compatibility. |
