...
[jvm]\
class [GPSTraceWalker](index.html)<[T](index.html)> : [MoveOnMapWithGPS](../-move-on-map-with-g-p-s/index.html)<[T](../-reproduce-g-p-s-trace/index.html)> 
