...
[jvm]\
class [LsaAscendingGradientDist](index.html)<[P](index.html) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.html)<[P](../../it.unibo.alchemist.model/-s-a-p-e-r-e-incarnation/index.html)>?> : [SAPERENeighborAgent](../-s-a-p-e-r-e-neighbor-agent/index.html)<[P](../../it.unibo.alchemist.model/-s-a-p-e-r-e-incarnation/index.html)>
