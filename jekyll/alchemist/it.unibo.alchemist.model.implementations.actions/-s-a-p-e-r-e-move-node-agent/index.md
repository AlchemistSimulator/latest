...
[jvm]\
abstract class [SAPEREMoveNodeAgent](index.html)<[P](index.html) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.html)<out [P](../../it.unibo.alchemist.model/-s-a-p-e-r-e-incarnation/index.html)>?> : [SAPERELocalAgent](../-s-a-p-e-r-e-local-agent/index.html)
