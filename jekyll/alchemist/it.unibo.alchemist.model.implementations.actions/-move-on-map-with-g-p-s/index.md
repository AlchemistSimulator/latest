...
[jvm]\
open class [MoveOnMapWithGPS](index.html)<[T](index.html)> : [MoveOnMap](../-move-on-map/index.html)<[T](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)> 
