...
[jvm]\
open class [MoveOnMapWithGPS](index.html)<[T](index.html)> : [MoveOnMap](../-move-on-map/index.html)<[T](../../it.unibo.alchemist.model.implementations.movestrategies.target/-follow-target-on-map/index.html)> 
