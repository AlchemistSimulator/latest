...
[jvm]\
class [ChemotacticPolarization](index.html)<[P](index.html) : [Position2D](../../it.unibo.alchemist.model.interfaces/-position2-d/index.html)<[P](../../it.unibo.alchemist.model/-biochemistry-incarnation/index.html)>?> : [AbstractAction](../-abstract-action/index.html)<[Double](https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html)>
