...
[jvm]\
abstract class [SAPEREMoveNodeAgent](index.md)<[P](index.md) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.md)<out [P](../../it.unibo.alchemist.model.implementations.linkingrules/-selective-adaptive-range/index.md)>?> : [SAPERELocalAgent](../-s-a-p-e-r-e-local-agent/index.md)
