...
[jvm]\
abstract class [AbstractNeighborAction](index.md)<[T](index.md)> : [AbstractRandomizableAction](../-abstract-randomizable-action/index.md)<[T](../../it.unibo.alchemist.model.implementations.conditions/-generic-molecule-present/index.md)> 
