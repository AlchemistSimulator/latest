//[alchemist](../../../index.md)/[it.unibo.alchemist.model.implementations.actions](../index.md)/[AbstractSteeringAction](index.md)

# AbstractSteeringAction

[jvm]\
abstract class [AbstractSteeringAction](index.md)<[T](index.md), [P](index.md) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.md)<[P](index.md)>, [Vector](../../it.unibo.alchemist.model.interfaces.geometry/-vector/index.md)<[P](index.md)>, [A](index.md) : [GeometricTransformation](../../it.unibo.alchemist.model.interfaces.geometry/-geometric-transformation/index.md)<[P](index.md)>>(**env**: [Environment](../../it.unibo.alchemist.model.interfaces/-environment/index.md)<[T](index.md), [P](index.md)>, **reaction**: [Reaction](../../it.unibo.alchemist.model.interfaces/-reaction/index.md)<[T](index.md)>, **pedestrian**: [Pedestrian](../../it.unibo.alchemist.model.interfaces/-pedestrian/index.md)<[T](index.md), [P](index.md), [A](index.md)>) : [AbstractMoveNode](../-abstract-move-node/index.md)<[T](index.md), [P](index.md)> , [SteeringAction](../../it.unibo.alchemist.model.interfaces/-steering-action/index.md)<[T](index.md), [P](index.md)> 

A [SteeringAction](../../it.unibo.alchemist.model.interfaces/-steering-action/index.md) in a vector space. The implementation of nextPosition is left to subclasses.

## Constructors

| | |
|---|---|
| [AbstractSteeringAction](-abstract-steering-action.md) | [jvm]<br>fun <[T](index.md), [P](index.md) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.md)<[P](index.md)>, [Vector](../../it.unibo.alchemist.model.interfaces.geometry/-vector/index.md)<[P](index.md)>, [A](index.md) : [GeometricTransformation](../../it.unibo.alchemist.model.interfaces.geometry/-geometric-transformation/index.md)<[P](index.md)>> [AbstractSteeringAction](-abstract-steering-action.md)(env: [Environment](../../it.unibo.alchemist.model.interfaces/-environment/index.md)<[T](index.md), [P](index.md)>, reaction: [Reaction](../../it.unibo.alchemist.model.interfaces/-reaction/index.md)<[T](index.md)>, pedestrian: [Pedestrian](../../it.unibo.alchemist.model.interfaces/-pedestrian/index.md)<[T](index.md), [P](index.md), [A](index.md)>) |
...
| [getNextPosition](get-next-position.md) | [jvm]<br>open override fun [getNextPosition](get-next-position.md)(): [P](index.md) |
...
| Name | Summary |
|---|---|
| [maxWalk](max-walk.md) | [jvm]<br>open val [maxWalk](max-walk.md): [Double](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-double/index.html)<br>The maximum distance the pedestrian can walk, this is a length. |

## Inheritors

| Name |
|---|
| [AbstractGroupSteeringAction](../-abstract-group-steering-action/index.md) |
| [AbstractLayerAction](../-abstract-layer-action/index.md) |
| [AbstractNavigationAction](../-abstract-navigation-action/index.md) |
| [AbstractSteeringActionWithTarget](../-abstract-steering-action-with-target/index.md) |
| [CognitiveAgentCombineSteering](../-cognitive-agent-combine-steering/index.md) |
| [CognitiveAgentFlee](../-cognitive-agent-flee/index.md) |
| [CognitiveAgentFollowScalarField](../-cognitive-agent-follow-scalar-field/index.md) |
| [CognitiveAgentObstacleAvoidance](../-cognitive-agent-obstacle-avoidance/index.md) |
| [CognitiveAgentSeek2D](../-cognitive-agent-seek2-d/index.md) |
