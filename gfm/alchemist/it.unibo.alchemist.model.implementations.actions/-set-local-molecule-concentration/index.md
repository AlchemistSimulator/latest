...
[jvm]\
class [SetLocalMoleculeConcentration](index.md)<[T](index.md)> : [AbstractActionOnSingleMolecule](../-abstract-action-on-single-molecule/index.md)<[T](../../it.unibo.alchemist.model.implementations.layers/-step-layer/index.md)>
