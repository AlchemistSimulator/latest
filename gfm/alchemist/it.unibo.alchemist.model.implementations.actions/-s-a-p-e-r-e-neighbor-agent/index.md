...
[jvm]\
abstract class [SAPERENeighborAgent](index.md)<[P](index.md) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.md)<[P](../../it.unibo.alchemist.model.implementations.linkingrules/-selective-adaptive-range/index.md)>?> : [SAPEREAgent](../-s-a-p-e-r-e-agent/index.md)
