...
[jvm]\
abstract class [AbstractAction](index.md)<[T](index.md)> : [Action](../../it.unibo.alchemist.model.interfaces/-action/index.md)<[T](../../it.unibo.alchemist.model.implementations.layers/-uniform-layer/index.md)> 
