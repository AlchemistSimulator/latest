...
[jvm]\
class [GPSTraceWalker](index.md)<[T](index.md)> : [MoveOnMapWithGPS](../-move-on-map-with-g-p-s/index.md)<[T](../../it.unibo.alchemist.model.implementations.movestrategies.speed/-trace-dependant-speed/index.md)> 
