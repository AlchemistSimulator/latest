...
[jvm]\
open class [GenericMoleculePresent](index.md)<[T](index.md) : [Number](https://docs.oracle.com/javase/8/docs/api/java/lang/Number.html)?> : [AbstractCondition](../-abstract-condition/index.md)<[T](../../it.unibo.alchemist.model.implementations.reactions/-chemical-reaction/index.md)> 
...
| [getQuantity](get-quantity.md) | [jvm]<br>open fun [getQuantity](get-quantity.md)(): [T](../../it.unibo.alchemist.model.implementations.reactions/-chemical-reaction/index.md)<br>Allows to access the threshold. |
