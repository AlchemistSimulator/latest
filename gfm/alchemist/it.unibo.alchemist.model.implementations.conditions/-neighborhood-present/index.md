...
[jvm]\
class [NeighborhoodPresent](index.md)<[T](index.md)> : [AbstractNeighborCondition](../-abstract-neighbor-condition/index.md)<[T](../../it.unibo.alchemist.model.implementations.nodes/-abstract-node/index.md)> 
