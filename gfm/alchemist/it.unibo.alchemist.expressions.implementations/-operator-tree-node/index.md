//[alchemist](../../../index.md)/[it.unibo.alchemist.expressions.implementations](../index.md)/[OperatorTreeNode](index.md)

# OperatorTreeNode

[jvm]\
open class [OperatorTreeNode](index.md) : [ATreeNode](../-a-tree-node/index.md)<[Double](https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html)>

## Constructors

| | |
|---|---|
| [OperatorTreeNode](-operator-tree-node.md) | [jvm]<br>open fun [OperatorTreeNode](-operator-tree-node.md)(op: [Operator](../-operator/index.md), left: [ITreeNode](../../it.unibo.alchemist.expressions.interfaces/-i-tree-node/index.md)<out [Any](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)>, right: [ITreeNode](../../it.unibo.alchemist.expressions.interfaces/-i-tree-node/index.md)<out [Any](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)>)<br>the operator |
...
| [getData](index.md#1261515164%2FFunctions%2F-267951372) | [jvm]<br>open fun [getData](index.md#1261515164%2FFunctions%2F-267951372)(): [T](../../it.unibo.alchemist.expressions.interfaces/-i-tree-node/index.md)<br>the object embedded in this node |
...
| Name | Summary |
|---|---|
| [operator](operator.md) | [jvm]<br>private val [operator](operator.md): [Operator](../-operator/index.md) |
