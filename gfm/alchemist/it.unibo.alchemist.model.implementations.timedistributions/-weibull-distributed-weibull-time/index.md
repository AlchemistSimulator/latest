...
[jvm]\
open class [WeibullDistributedWeibullTime](index.md)<[T](index.md)> : [WeibullTime](../-weibull-time/index.md)<[T](../../it.unibo.alchemist.model.implementations.layers/-uniform-layer/index.md)> 
