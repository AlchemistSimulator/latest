...
~~interface~~ [~~GraphicalOutputMonitor~~](index.md)~~<~~[T](index.md)~~,~~ [P](index.md) : [Position](../../it.unibo.alchemist.model.interfaces/-position/index.md)<out [P](../-graphical2-d-output-monitor/index.md)>?~~>~~ ~~:~~ [~~OutputMonitor~~](../-output-monitor/index.md)~~<~~[~~T~~](../-graphical2-d-output-monitor/index.md)~~,~~ [~~P~~](../-graphical2-d-output-monitor/index.md)~~>~~ 
...
| [initialized](../-output-monitor/initialized.md) | [jvm]<br>abstract fun [initialized](../-output-monitor/initialized.md)(p: [Environment](../../it.unibo.alchemist.model.interfaces/-environment/index.md)<[T](../-graphical2-d-output-monitor/index.md), [P](../-graphical2-d-output-monitor/index.md)>) |
...
| [stepDone](../-output-monitor/step-done.md) | [jvm]<br>abstract fun [stepDone](../-output-monitor/step-done.md)(p: [Environment](../../it.unibo.alchemist.model.interfaces/-environment/index.md)<[T](../-graphical2-d-output-monitor/index.md), [P](../-graphical2-d-output-monitor/index.md)>, p1: [Reaction](../../it.unibo.alchemist.model.interfaces/-reaction/index.md)<[T](../-graphical2-d-output-monitor/index.md)>, p2: [Time](../../it.unibo.alchemist.model.interfaces/-time/index.md), p3: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)) |
